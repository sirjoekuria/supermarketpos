...
import { Save, Building2, Receipt, Palette, Shield, UserCog } from "lucide-react";
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          {activeTab === "appearance" && (
            <div className="bg-white dark:bg-pos-card rounded-2xl border border-gray-200 dark:border-pos-border p-6 space-y-4">
              ...
              <div className="flex items-center justify-between mt-4 p-4 bg-gray-50 dark:bg-gray-800/50 rounded-xl border border-gray-200 dark:border-pos-border">
                <div>
